...
public class NewsController {
    ...
    @Operation(summary = "For ADMINS,SUPER_ADMINS ,This API is used for create a News", responses = {
    ...
    @Operation(summary = "For ADMINS,SUPER_ADMINS,USERS ,This API is used for get an existing news", responses = {
    ...
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'ADMIN', 'USER')")
    @Operation(summary = "For ADMINS,SUPER_ADMINS,USERS ,This API is used for get paged news", responses = {
    ...
    @Operation(summary = "For ADMINS,SUPER_ADMINS ,This API is used for update news", responses = {
    ...
    @Operation(summary = "For ADMINS,SUPER_ADMINS ,This API is used for delete news", responses = {
